...
class CookieContractService(
	...
	private fun mintCookieByAdmin(cookieInfo: CookieInfo): BigInteger? {
		return try {
			...
			val functionParams: List<Any> = Arrays.asList(cookieInfo.creatorAddress, cookieInfo.title, cookieInfo.content, cookieInfo.imageUrl, cookieInfo.tag, cookieInfo.hammerPrice)
